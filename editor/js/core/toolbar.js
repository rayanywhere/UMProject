var Toolbar = {
	...
	init:function() {
		...
		Toolbar.root.find(".widget.trash").droppable({accept:"#tree .widget,#editor .widget", hoverClass:"ui-state-highlight", drop: Toolbar._onRemove});
		Toolbar.root.find(".widget.transfer").droppable({accept:"#tree .widget.data", hoverClass:"ui-state-highlight", drop: Toolbar._onSave});
